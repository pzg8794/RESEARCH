...
certificate in disability and inclusive practice, and an earlier computer
science thesis on image-based ASL recognition.
...
\hfill 2015\\
Thesis: \textit{ASL Recognition Application}; image processing, feature
extraction, and neural pattern classification
...
\textbf{ASL Recognition Application.}
Designed an image-processing and neural-pattern-classification system as an
M.S.\ Computer Science thesis. This is technical research experience, not a
formal ASL language-proficiency credential.
...
Languages & Spanish: native/fluent; English: fluent; ASL: technical research background without a formal proficiency credential\\
\end{tabularx}
