...
- [University of Rochester Fulbright
  timeline](https://www.rochester.edu/college/studentfellowships/deadlines/fulbright.html)
- [Prospective Applicant
  Form](https://form.jotform.com/90414762363153)
- [Fulbright Planning
...
- [x] Late-entry eligibility requested.
- [x] Fellowships Office confirmed that a late application and campus
  endorsement path are still possible.
...
The form does not allow saving, returning, or editing after submission. It
also includes legal waivers, FERPA-related permissions, conduct questions,
optional publicity and essay-use permissions, and an electronic signature.

Prepare these before starting:

- legal name and pronouns;
- UofR and personal email;
- preferred phone number;
- graduate program, degree, completion year, and current GPA;
- undergraduate institution, degree, and GPA;
- permanent address and citizenship;
- at least one recommender's name, email, title, and organization;
- current resume PDF;
- personal decisions on every waiver and permission.
...
- **July 30:** late starter's first full application draft, references
  confirmed, and advisor meeting scheduled.
- **August 24:** full revised application and recommendations ready for campus
  committee review. Mark the application `Ready for Review`; do **not** press
  the official Fulbright submit button.
- **September 8:** affiliation letter and Foreign Language Evaluation due for
  the campus process.

The campus timeline says not to use generative AI to compose application
statements. This repo may organize deadlines, source evidence, factual fields,
and user-authored drafts, but it must not generate the Fulbright essays or
short responses.
