...
Updated: 2026-09-09 deadline audit

Applicant: Piter Garcia

Target entry: Fall 2027

Current status: pre-application work launched; no Fall 2027 portal submission is recorded yet

## Decision

Start now. The strongest portfolio is not one application to a single famous school. It is a balanced set of funded programs that can support the same research agenda from different disciplinary homes:

- fairness-aware artificial intelligence and decision-making under uncertainty;
- clinical data science, bioinformatics, and diagnostic equity;
...
| 2 | [University of Rochester Computer Science PhD](./programs/uofr-computer-science.md) | Strong local fit | Jan 5 | Full tuition, stipend, and health insurance for PhD students in good standing | Current official page; cycle label must be rechecked | Pre-application | Confirm three faculty and draft a one-page fit map |
| 3 | [University of Rochester Statistics PhD](./programs/uofr-statistics.md) | Strong clinical and bioinformatics fit | Priority: Dec 1; final: Dec 15 | Full tuition scholarship, health insurance, and competitive stipend | Explicit entering Spring/Fall 2027 page | Pre-application | Select three faculty and frame EQUITAS as a statistical-inference and missing-data agenda |
...
1. NYU GSAS permits only one application per term. Do not submit both NYU CDS and NYU Courant Computer Science. CDS is the current primary; Courant is an alternate only.
2. RIT currently lists the GRE as required. No verified score report has been located in the application archive.
3. University of Rochester Data Science and Healthcare Data Science and AI are master's programs, not PhD applications. The active Rochester PhD routes are Computer Science and Statistics.
4. CMU HCII now displays November 18 and December 9 dates, but its cycle heading conflicts with its 2027-start statement. Keep those dates provisional until the live portal or corrected page resolves the cycle label.
...
| Internal date | Work product | Status |
| --- | --- | --- |
| Aug 12, 2026 | Academic-record audit: exact degree titles, current transcripts, GPA presentation, and GRE status | Ready to schedule |
...
These targets create review time before each official deadline. They are not official deadlines.
...
| NYU Data Science | To be set after official dates post | TBD; official page says details are coming soon |
| CMU HCII | Nov 4, 2026 provisional early target | Nov 18 early / Dec 9 final, both provisional pending cycle-label confirmation |
| RIT CIS | Dec 17, 2026 | Dec 31 priority |
| Rochester Computer Science | Dec 18, 2026 | Jan 5 |
...
- [MIT EECS admissions FAQ](https://www.eecs.mit.edu/academics/graduate-programs/admission-process/graduate-admissions-faqs/) and [funding](https://www.eecs.mit.edu/academics/graduate-programs/funding/)
- [RIT CIS PhD](https://www.rit.edu/study/computing-and-information-sciences-phd)
- [University of Rochester graduate deadlines](https://www.rochester.edu/college/gradstudies/admissions/apply.html), [Computer Science application](https://cs.rochester.edu/graduate/how-to-apply.html), and [Statistics requirements](https://www.urmc.rochester.edu/education/graduate/application-requirements-by-program)
...
Every update must record the date checked, official source, application status, next action, and whether the fact is explicit for Fall 2027. Portal status and recommender status must never be inferred from a planning document.
