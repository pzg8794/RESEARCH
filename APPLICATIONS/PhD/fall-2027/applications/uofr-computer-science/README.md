# University of Rochester Computer Science PhD — Fall 2027
...
- Application fee: $70.
- Official instructions: [Computer Science graduate applications](https://cs.rochester.edu/graduate/how-to-apply.html)
- Portal: [Rochester Graduate Admissions](https://apply.grad.rochester.edu/apply/)
...
Lead with reliable AI/data systems under incomplete or heterogeneous evidence. Health, assistive technology, and education are evaluation/application settings. Keep EQUITAS as a motivating fairness framework, not a claimed finished CS contribution.
