# Fall 2027 PhD Calendar and Milestone Ledger

Updated: 2026-08-06

Calendar target: Piter's g.rit.edu Google Calendar

Scheduling preference: afternoons when possible

Calendar verification: all rows marked `Created and verified` were found in the signed-in `pzg8794@g.rit.edu` Google Calendar after creation.

This file records both the planned calendar item and whether it has actually been created. A row marked `planned` is not a calendar event.

## Preparation milestones

| Date | Time | Calendar title | Purpose | Calendar status |
| --- | --- | --- | --- | --- |
...
| Date | Time | Calendar title | Scope | Calendar status |
| --- | --- | --- | --- | --- |
| Fri Sep 25, 2026 | 2:00-3:00 PM ET | RECHECK: Fall 2027 PhD cycle dates | Verify explicit Fall 2027 dates for MIT EECS, RIT CIS, Rochester Computer Science, CMU HCII, UC Berkeley Information, Cornell Information Science, Northwestern Learning Sciences, and Purdue Engineering Education from official sources; never reuse a prior-cycle date or infer a missing date | Created and verified after scope expansion; no live timed conflict; one-week, one-day, and one-hour reminders |

## Admissions events

| Date | Time | Calendar title | Purpose | Calendar status |
| --- | --- | --- | --- | --- |
| Fri Oct 16, 2026 | 10:15-10:45 AM ET | PREP: UMSI doctoral admissions information session | Review the [public-safe preparation kit](../../../PREPARATION/meetings/2026-10-16-umsi-doctoral-admissions-information-session.md) before the virtual session | Created and verified; no live timed conflict; one-day reminder |
| Fri Oct 16, 2026 | 11:00 AM-noon ET | REGISTER/ATTEND: UMSI doctoral admissions information session | Official virtual event; registration is required and the private Zoom link arrives one hour before the session | Created and verified; registration remains pending; no live timed conflict; one-week, one-day, and one-hour reminders |

## Internal submission targets

| Date | Calendar title | Calendar status |
| --- | --- | --- |
...
| Dec 18, 2026 | Internal submit target: Rochester Computer Science PhD | Created and verified; one-week and one-day reminders at 9 AM |

## Official deadlines

| Date | Calendar title | Verification | Calendar status |
| --- | --- | --- | --- |
...
- Cycle-date rechecks: one-week, one-day, and one-hour reminders.
- External admissions events: one-week, one-day, and one-hour reminders.
...
- Never mark an application submitted based on a calendar event; submission requires portal evidence.
