...
\begin{itemize}
  ...
  \item \textit{Designing Equitable AI Systems for Diagnostics} (IDAI700 Research Portfolio) --- ethical AI framework for providers and patients from marginalized communities in clinical settings.
  ...
  \item \textit{Equitable Bioinformatics: Enhancing Diagnostic Decision-Making through RNA and Biomarker Data} (ISTE-780 Project Report) --- fairness-aware ML framework for genomic diagnostic algorithms with reproducible bias detection.
