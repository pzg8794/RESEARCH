...
\begin{itemize}
  ...
  \item \textit{Equitable Bioinformatics: Enhancing Diagnostic Decision-Making through RNA and Biomarker Data} (ISTE-780 Project Report) --- systematic fairness assessment applied to ML-driven diagnostics, with reproducible SHAP-based bias detection.
\end{itemize}
