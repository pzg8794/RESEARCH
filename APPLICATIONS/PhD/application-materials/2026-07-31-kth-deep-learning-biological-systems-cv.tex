...
\begin{itemize}
  ...
  \item \textit{Predicting Hospital Readmission Rates: A Multi-Method ML Analysis} (DSCI-633 Project Report) --- ensemble and regularized regression methods for clinical risk stratification on large EHR-derived datasets.
