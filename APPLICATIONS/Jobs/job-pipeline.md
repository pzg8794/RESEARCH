...
| P0 | [Jobot - Senior AI/ML Engineer](https://jobot.com/apply/senior-ai-ml-engineer/d261bced01) | 100% remote in the United States; $140,000-$180,000; public-service form and workflow automation | Strong Python, applied ML, model evaluation, production-system, public-service, and .NET integration background; direct Azure AI Search, RAG, and RLHF production experience is a stretch | **Application prefilled / final legal handoff** | Contact fields are complete, `No` is selected for SMS, and the targeted [resume](./application-materials/2026-08-03-jobot-senior-ai-ml-engineer-resume.pdf) is attached. The missed morning review was moved to **2026-08-03, 6:30 PM**. Piter reads the communications/privacy notice and clicks `Apply Now` only if accepted. Preserve the receipt before marking submitted. |
...
| P1 | [Carney, Sandoe & Associates 2027-2028 Teaching Fellowship](https://app.joinhandshake.com/jobs/11080650) | Nationwide K-12 independent-school placement support; employer service is free; listed salary range $40,000-$50,000 | High for CS teaching and post-December relocation | **Application prepared / final submission handoff** | The recruiter directed Piter to this listing. A targeted [one-page teaching resume](./application-materials/2026-08-03-carney-sandoe-teaching-fellow-resume.pdf) is attached and the unrelated data-science resume was removed. Final review and `Submit Application` are calendared for **2026-08-04 at 2:00 PM**. |
...
- 2026-08-03 at 6:30 PM: Final review of the prefilled Jobot Senior AI/ML
  Engineer application. The tailored resume is attached; only the legal and
  communications notice plus final `Apply Now` click remain.
...
- 2026-08-04 at 2:00 PM: Review and submit the prepared Carney 2027-2028
  Teaching Fellowship application, then answer the Teaching Retreat dietary
  question in the same short review block.
