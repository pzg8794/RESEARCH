...
| P0 | [Jobot - Senior AI/ML Engineer](https://jobot.com/apply/senior-ai-ml-engineer/d261bced01) | 100% remote in the United States; $140,000-$180,000; public-service form and workflow automation | Strong Python, applied ML, model evaluation, production-system, public-service, and .NET integration background; direct Azure AI Search, RAG, and RLHF production experience is a stretch | **Application complete / final legal handoff** | Contact fields are complete, `No` is selected for SMS, and the targeted [resume](./application-materials/2026-08-03-jobot-senior-ai-ml-engineer-resume.pdf) was attached and verified on August 4. Piter reads the communications/privacy notice and clicks `Apply Now` only if accepted. Preserve the receipt before marking submitted. |
...
- 2026-08-04: The Jobot Senior AI/ML Engineer form was reopened, its documented
  contact fields were restored, `No` was selected for SMS, and the targeted
  resume was attached and verified. Piter reviews the communications/privacy
  notice and completes the final `Apply Now` action if accepted.
