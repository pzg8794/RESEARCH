...
| P0 | [Handshake AI - AI Evaluation Specialist](https://app.joinhandshake.com/public/jobs/11054661) | Remote in the United States; flexible; no minimum hours; $17-$30/hour | High for AI/ML, model evaluation, and immediate income | Needs confirmation | Onboarding is open. Work authorization is complete, the existing quantum/AI CV is attached, and expertise fields are prepared. Review and accept the legal agreements only with Piter's confirmation, then complete identity verification. |
...
- 2026-07-30: Check for replies from Handshake AI, Carney Sandoe, Stride,
  Cardinal Education, Epic, Ampact, and Solü.
