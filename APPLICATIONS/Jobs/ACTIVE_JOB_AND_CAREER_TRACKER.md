...
| P0 | RIT email opportunity sweep | **UPDATED AUG. 26** | The latest RIT pass captured the approved WRP Application 101 registration for Sep. 9 and the Sep. 3 resume/CV workshop. The workshop registration remains blocked at RIT SSO/Duo. The WRP/federal application itself remains unsubmitted and still requires secure document upload, final review, attestation, and authorized submission. |
