...
| P0 | RIT Student Government Technology Services | **CAMPUSGROUPS FORM OPENED; NOT SUBMITTED** | Five roles are available through Sep. 4 at 11:59 PM: Front-End Developer, Back-End Developer, System Administrator, Documentation Specialist, and Web Designer. Strongest fit is Front-End, Back-End, and Documentation. Compensation is not verified. Complete the evidence-grounded form, confirm pay and hours, submit, and preserve the receipt. [Work package](./work-packages/2026-08-26-rit-student-government-tech/README.md) |
| P0 | Current WRP/federal application | **READY FOR SECURE DOCUMENT UPLOAD; NOT SUBMITTED** | A signed provider letter was received Aug. 19 and verified to contain the required Schedule A / 5 CFR 213.3102(u) language. The application already has the tailored resume and RIT/UofR transcripts. Upload the letter securely as **Disability Letter (Schedule A)**, verify Application and Documents complete, complete the final attestation, submit only with authorization, and preserve the receipt privately. [Work package](./work-packages/2026-08-17-wrp-follow-up/README.md) |
| P0 | RIT email opportunity sweep | **COMPLETED AUG. 17 - ALL CATEGORIES** | Rechecked RIT All Mail across Primary, Social, Updates, job-alert, and response-label results. The Lucky Mishra remote AI Developer reply is sent and has no newer recruiter response; the Torrance hybrid role remains closed for the current opening; the Schedule A letter was received and verified Aug. 19, while secure upload and final application submission remain. Automated role digests were screened and the worthwhile leads are captured below. |
