...
| Carney, Sandoe & Associates 2027-2028 Teaching Fellowship | **HANDSHAKE SUBMITTED AUG. 4 / CANDIDATECONNECT INCOMPLETE** | Handshake and email receipts verify the Aug. 4 submission. The separate official CandidateConnect application has no completion receipt and currently requires sign-in/account completion. Do not duplicate the Handshake application; complete CandidateConnect, preserve its receipt, then notify Brenden. |
...
| P0 | Current WRP/federal application | **LOGIN COMPLETE; READY FOR SECURE DOCUMENT UPLOAD; NOT SUBMITTED** | Login.gov access was completed Aug. 26 and the USAJOBS document-selection page reopened. A signed provider letter was received Aug. 19 and verified to contain the required Schedule A / 5 CFR 213.3102(u) language. The application already has the tailored resume and RIT/UofR transcripts. Upload the letter securely as **Disability Letter (Schedule A)**, verify Application and Documents complete, complete the final attestation, submit only with authorization, and preserve the receipt privately. [Work package](./work-packages/2026-08-17-wrp-follow-up/README.md) |
| P0 | RIT email opportunity sweep | **UPDATED AUG. 26; WORKSHOP REGISTRATION VERIFIED** | The latest RIT pass captured the approved WRP Application 101 registration for Sep. 9 and the Sep. 3 resume/CV workshop. Career Connect now displays **“You're Attending”** for the workshop. The WRP/federal application itself remains unsubmitted and still requires secure document upload, final review, attestation, and authorized submission. |
...
| P0 | Jobot Machine Learning Engineer - Predictive Intelligence | **APPLICATION SUBMITTED / RECEIPT VERIFIED AUG. 25; PROFILE EXTRAS INCOMPLETE** | Jobot displays that the application was submitted Aug. 25 and received. The Jobot profile/elevator pitch remain incomplete, and no instant-interview completion is verified for this role. Do not reapply; optionally complete only the evidence-grounded profile and elevator pitch without claiming Google Meridian, Prophet, Cloud Run, or other unsupported depth. |
