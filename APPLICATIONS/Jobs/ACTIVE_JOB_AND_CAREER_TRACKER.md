...
| P0 | UofR Graduate Writing Consultant | **GMAIL DRAFT COMPLETE WITH THREE VERIFIED ATTACHMENTS; NOT SENT** | The UofR Gmail draft contains the required private fields and the upload-confirmed tailored CV, cover letter, and 12-page BIO614 writing sample. Review the populated draft, send only after final action-time confirmation, and preserve the sent message before recording `SUBMITTED`. [Work package](./work-packages/2026-08-26-uofr-writing-consultant/README.md) |
