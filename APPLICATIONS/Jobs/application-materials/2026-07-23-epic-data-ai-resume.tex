...
\begin{center}
  ...
  {\large Data Science, Machine Learning, and Applied AI}\\[2pt]
...
\section*{Summary}
Applied data science and machine learning professional with graduate research
experience in AI-driven quantum network optimization and industry experience
building Python analytics and data workflows in healthcare and production
environments. Strong in data preparation, feature engineering, supervised
learning, model evaluation, reproducible experimentation, and technical
communication, with an additional foundation in inclusive CS education.

\section*{Technical Skills}
\begin{tabularx}{\textwidth}{@{}>{\bfseries}l X@{}}
Programming & Python, SQL, R, Java, C++, C\#, JavaScript, Bash, MATLAB\\
Data and ML & pandas, NumPy, SciPy, scikit-learn, TensorFlow, Keras, PyTorch, XGBoost, statistical analysis, feature engineering, model evaluation\\
Visualization & Matplotlib, Plotly, Seaborn, technical reporting, presentation development\\
...
\begin{itemize}
  ...
  \item Develop comparison-ready evaluation workflows across stochastic and
    adversarial environments, with automated validation, structured logging,
    shared datasets, and reproducible experiment tracking.
  \item Translate large-scale experiments into benchmark analyses, technical
    reports, and manuscript-ready artifacts for faculty-led publication work.
\end{itemize}
...
Built reproducible simulation and evaluation workflows for adaptive
decision-making under noisy, adversarial, and resource-constrained conditions.
