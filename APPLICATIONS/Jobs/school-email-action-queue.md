...
1. Keep unresolved messages starred when the mailbox supports that workflow.
2. Remove a star only after the message is handled and recorded.
3. Record deadlines and decisions, not private balances, account numbers,
...
- [ ] **P0 - UofR / EDU486:** Finish the poster and attend the **2026-07-31**
  ...
  Arrange poster coverage or notify the course team and leave by 2:45 PM for
  the accepted 3:00 PM Fulbright meeting in Dewey Hall 4-209B.
- [ ] **P0 - RIT / HESC:** Log in to the HESC account and record the denial
  reason for the 2026-27 NYS Student Aid Payment Application. Determine whether
  the next step is a correction, appeal, or closure.
...
| Priority | Category | Item | Current status | Next action |
| --- | --- | --- | --- | --- |
| Complete | Fellowship | [UofR Fulbright advising outcome](../../PREPARATION/meetings/2026-08-06-fulbright-advising-outcome.md) | August 6 consultation completed; Belinda Redden recommended Spain ETA as the viable current-cycle route and Open Study/Research as a future Ph.D.-stage option | Execute the Spain ETA draft, recommender, Foreign Language Evaluation, and campus-review plan below. |
...
| P0 | Fellowship | [Fulbright Spain English Teaching Assistant](https://us.fulbrightonline.org/countries/europe-and-eurasia/spain/1768) | FPA-recommended current-cycle route; central duties remain English communication and U.S. cultural exchange, with Galicia and La Rioja secondary or vocational placements as the initial focus | Complete the applicant-written draft and online application by August 15 for campus submission by August 17; register three ETA recommenders, secure the mandatory Spanish evaluation, and do not final-submit nationally. |
| P0 | Fellowship | [Fulbright Spain Foreign Language Evaluation](https://www.sas.rochester.edu/mlc/people/faculty/komocki_kirt/index.html) | Kirt Komocki is the officially verified first-contact candidate because his UofR profile explicitly assigns him `Language Placement Advisor, Fulbright assessments`; as of August 6 he has not been contacted, confirmed, or registered | Review and send the [outreach draft](../Fellowships/2026-08-06-fulbright-spanish-fle-outreach-draft.md), obtain consent, then register the evaluator in the Fulbright portal for the September 8 deadline. If unavailable, request routing through MLC or the Fellowships Office. |
| P1 | Fellowship / peer outreach | [Lizmairi Vargas Santa '26](https://www.rochester.edu/newscenter/national-merit-based-award-winners-study-research-and-teaching-606312/) | Verified Rochester graduate from Azua and Projects for Peace recipient; identified but not contacted. No reviewed source identifies her as a Fulbright recipient. | Review the [unsent outreach draft](../Fellowships/2026-08-06-fulbright-dominican-alumna-outreach-draft.md), then ask Belinda or the Fellowships Office for a warm introduction or to forward the note. Do not use Penpal's placeholder contact details. |
...
- [x] Submitted Health Data Max with the tailored one-page resume, cover
  letter, and combined RIT/UofR unofficial transcript PDF; Handshake displayed
  its confirmation.
...
- [x] Prepared the Fulbright Spain ETA intake resume, submitted the Planning
  Tool, prefilled the Prospective Applicant Form, and sent the corrected reply
  and advising appointment request.
- [x] Sent the Guidepoint follow-up and verified that the VDart screening
  follow-up was already sent, avoiding a duplicate.
- [x] Imported 23 deadlines, review blocks, registered events, and holds into
  the primary RIT Google Calendar; Google confirmed all 23 events.
...
- [x] Reviewed the RIT billing deadline, HESC denial notice, TEACH Grant
  notification, Direct PLUS confirmation, parking-permit dates, and remaining
  ProFellow newsletter.
- [x] Removed the star from the fully processed ProFellow newsletter; its live
  opportunities were already recorded in the fellowship queue.
- [x] Authenticated to the University of Rochester mailbox and checked new,
  important, starred, and career/funding searches on 2026-07-24.
- [x] Checked LearningMate, Solu, Handshake AI, Carney Sandoe, Stride,
  Cardinal Education, Epic, Ampact, Handshake account verification, and HESC;
  no new employer or program reply arrived on 2026-07-24.
...
- [x] Sent a UofR Fulbright late-entry inquiry to the Student Fellowships
  ...
  unresolved.
- [x] Removed the star from the completed RIT graduation confirmation and
  starred the unresolved July 1 StudentAid.gov TEACH Grant notification.
- [x] Removed stars from the fully processed UofR research digest, Gemini
